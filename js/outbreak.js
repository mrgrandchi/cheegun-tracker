...
function reveal(){const last=explored.at(-1);if(!last||dist(last,player)>52)explored.push([...player]);explored=explored.slice(-52);currentVision.setLatLng(player);currentVision.setRadius(effectiveVisionRadius());redrawFog()}
