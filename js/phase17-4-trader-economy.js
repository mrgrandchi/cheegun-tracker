...
function repDiscount(){const faction=window.CheegunFactions?.modifier?.("traders")?.discount||0;const settlement=window.CheegunSettlement?.bonuses?.().trader||0;return Math.min(.32,reputation()*.01+faction+settlement)}
